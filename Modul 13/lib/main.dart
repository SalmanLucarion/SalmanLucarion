...
import 'package:http/http.dart' as http; // [cite: 40]
import 'dart:convert'; // [cite: 42]
import 'package:intl/intl.dart'; // [cite: 44]
import 'package:google_fonts/google_fonts.dart'; // [cite: 46]

void main() {
  runApp(const MyApp()); // [cite: 49]
}
...
// --- Model Class (Langkah f) --- [cite: 50, 53]
class Post {
  final int id;
  final int userId;
  final String title;
...
// --- HomePage Widget (Langkah g) --- [cite: 54, 56]
...
class HomePageState extends State<HomePage> {
  ...
  // --- Logic: Create Post (Langkah h) --- [cite: 126, 128]
  ...
  // --- Logic: Update Post (Langkah m) --- [cite: 150, 152]
  ...
  // --- Logic: Delete Post (Langkah q) --- [cite: 165, 170]
  ...
  // --- Dialog: Add Post (Langkah i) --- [cite: 130, 133]
  ...
  // --- Dialog: Update Post (Langkah n) --- [cite: 154, 156]
  ...
  // --- Dialog: Delete Confirmation (Langkah r) --- [cite: 242, 244]
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // --- Modifikasi Body (Langkah k & o) --- [cite: 147]
      body: Center(
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // --- Modifikasi Text Judul dengan Row & PopupMenu (Langkah o & s) --- [cite: 162, 262]
                      Row(
      ...
      // --- Floating Action Button (Langkah j) --- [cite: 139, 140, 141]
